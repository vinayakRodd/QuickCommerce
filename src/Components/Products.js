...
function Products({UserName,MyProducts,cart,setCart,setCount,count,GTotal,setGTotal}) {
  ...
  return (
    <div>
        <div style={{display:'flex',flexDirection:'row',gap:'30px'}}>
            <i style={{fontSize:'60px',color:'darkslategray'}} class="bi bi-person-circle"></i>
